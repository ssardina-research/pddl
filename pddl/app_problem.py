...
from pddl.formatter import _print_objects_with_types, _remove_empty_lines, _sort_and_print_collection
...
class APPProblem(Problem):
    ...
    def __str__(self) -> str:
        ...
        indentation = " " * 4
        body += f"(:objects {_print_objects_with_types(self.objects)})\n"
